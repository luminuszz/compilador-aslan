...
class LexerLotr:
    def __init__(self, code):
        ...
        self.token_specs = [
            ...
            ('NUMERO',      r'\d+(\.\d*)?'),
            ('IF',          r'\bnao_passara\b'),
            ('ELSE',        r'\bfuja_tolos\b'),
            ('WHILE',       r'\bqueda_em_khazaddum\b'),
            ('PRINT',       r'\bcajado_brilha\b'),
            ('READ',        r'\bouvir_nas_trevas\b'),
            ('TRUE',        r'\bfogo_secreto\b'),
            ('FALSE',       r'\bsombras_profundas\b'),
            ('INT',         r'\bpoder_maia\b'),
            ('BOOL',        r'\bchama_de_udun\b'),
